...
function submitOrder() {
  ...
  if (user.cart.length > 0) {
    ...
    let order1 = user.hoadon[user.hoadon.length - 1];

    let div = document.createElement('div');
    let orderDate = new Date(order1.orderId); // Dùng `orderId` làm dấu thời gian
...
function capnhat_hoadon() {
 ...
 <div  class="hoadon-con-tk-1">
     ...
     <div class="hoadon-con-tk-2">
            ...
            <p><strong>Trạng thái:</strong><span style="color:red;">${order.status}</span></p>
